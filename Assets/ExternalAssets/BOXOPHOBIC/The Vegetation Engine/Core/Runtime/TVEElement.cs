...
#if UNITY_EDITOR
        [StyledMessage("Error", "The current element is outside the Global Volume / Render Volume or the material is missing the ElementType tag and it is not rendered! Activate the scene Gizmos to see the volume bounds!", 0, 10)]
