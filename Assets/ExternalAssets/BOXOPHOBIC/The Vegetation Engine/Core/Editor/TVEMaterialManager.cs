...
namespace TheVegetationEngine
{
    public class TVEMaterialManager : EditorWindow
    {
        ...
        List<TVEMaterialData> renderSettings = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_RenderDecals", "Render Decals", -9999, "Off 0 On 1", false),
            new TVEMaterialData("_RenderSSR", "Render SSR", -9999, "Off 0 On 1", false),
            ...
            new TVEMaterialData("_FadeCameraValue", "Fade Proximity", -9999, 0, 1, false, false),

            new TVEMaterialData("_AI_Parallax", "Impostor Parallax", -9999, 0, 1, false, true),
            new TVEMaterialData("_AI_ShadowView", "Impostor Shadow View", -9999, 0, 1, false, false),
            new TVEMaterialData("_AI_ShadowBias", "Impostor Shadow Bias", -9999, 0, 1, false, false),
            new TVEMaterialData("_AI_TextureBias", "Impostor Texture Bias", -9999, false, false),
            new TVEMaterialData("_AI_Clip", "Impostor Alpha Treshold", -9999, 0, 1, false, false),
        };
        ...
        List<TVEMaterialData> mainData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_ImpostorColor", "Impostor Color", new Color(-9999, 0,0,0), true, true),
            new TVEMaterialData("_ImpostorSmoothnessValue", "Impostor Smoothness", -9999, 0, 1, false, false),
        };
        ...
        List<TVEMaterialData> secondData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_DetailValue", "Detail Blend Intensity", -9999, 0, 1, false, true),
            new TVEMaterialData("_DetailNormalValue", "Detail Blend Normals", -9999, 0, 1, false, false),
            ...
            new TVEMaterialData("_DetailMeshMode", "Detail Surface Mask", -9999, "Vertex_Blue 0 Projection 1", true),
            new TVEMaterialData("_DetailMeshMinValue", "Detail Surface Min", -9999, 0, 1, false, false),
            new TVEMaterialData("_DetailMeshMaxValue", "Detail Surface Max", -9999, 0, 1, false, false),
            new TVEMaterialData("_DetailMaskMode", "Detail Texture Mask", -9999, "Main_Mask 0 Detail_Mask 1", false),
            new TVEMaterialData("_DetailMaskMinValue", "Detail Texture Min", -9999, 0, 1, false, false),
            new TVEMaterialData("_DetailMaskMaxValue", "Detail Texture Max", -9999, 0, 1, false, false),
        };
        ...
        List<TVEMaterialData> noiseData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_NoiseMinValue", "Noise Mask Min", -9999, 0, 1, false, false),
            new TVEMaterialData("_NoiseMaxValue", "Noise Mask Max", -9999, 0, 1, false, false),
            new TVEMaterialData("_NoiseScaleValue", "Noise Mask Scale", -9999, 0, 10, false, false),

            new TVEMaterialData("_NoisePositionMode", "Use Pivot Position for Noise", -9999, true),
        };
        ...
        List<TVEMaterialData> subsurfaceData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_SubsurfaceThicknessValue", "Subsurface Thickness", -9999, 0, 16, false, false),
        ...
        List<TVEMaterialData> emissiveData = new List<TVEMaterialData>
        {
            ...
            new TVEMaterialData("_EmissiveFlagMode", "Emissive GI", -9999, "None 0 Any 1 Baked 2 Realtime 3", true),
            new TVEMaterialData("_EmissiveIntensityMode", "Emissive Value", -9999, "Nits 0 EV100 1", false),
            new TVEMaterialData("_EmissivePhaseMode", "Emissive Phase", -9999, "Fade_In 0 Fade_In_and_Out 1", false),
            ...
            new TVEMaterialData("_EmissiveIntensityValue", "Emissive Power", -9999, false, false),
            new TVEMaterialData("_EmissivePhaseValue", "Emissive Phase", -9999, 0, 1, false, false),
            new TVEMaterialData("_EmissiveExposureValue", "Emissive Weight", -9999, 0, 1, false, false),
            new TVEMaterialData("_EmissiveTexMinValue", "Emissive Tex Min", -9999, 0, 1, false, false),
            new TVEMaterialData("_EmissiveTexMaxValue", "Emissive Tex Max", -9999, 0, 1, false, false),
