...
namespace TheVegetationEngine
{
    public class TVEHub : EditorWindow
    {
        ...
        const int VERSION_REQUIRES_UPDATE = 1000;
        const int VERSION_REQUIRES_BACKUP = 1000;
...
#if UNITY_2023_1_OR_NEWER
                PlayerSettings.SetScriptingDefineSymbols(new UnityEditor.Build.NamedBuildTarget(), defineSymbols);
#else
