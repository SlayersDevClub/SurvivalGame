...
namespace TheVegetationEngine
{
    public class TVEAssetsManager : EditorWindow
    {
        ...
        {
        "Selected Assets", "Selected Folder",
        };
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button("Delete TVEPrefab Component", GUILayout.Height(24)))
            {
                allAssetsPaths = new List<string>();
            ...
            if (GUILayout.Button("Cleanup Mesh Name GUID", GUILayout.Height(24)))
            {
                allAssetsPaths = new List<string>();
