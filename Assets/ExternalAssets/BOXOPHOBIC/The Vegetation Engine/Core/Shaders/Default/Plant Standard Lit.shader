	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 temp_cast_12 = (temp_output_7_0_g76503).xxx;
				float temp_output_10_0_g76503 = ( _EmissiveTexMaxValue - temp_output_7_0_g76503 );
				half3 Emissive_Texture7022_g76277 = saturate( ( ( (SAMPLE_TEXTURE2D( _EmissiveTex, sampler_Linear_Repeat, Emissive_UVs2468_g76277 )).rgb - temp_cast_12 ) / ( temp_output_10_0_g76503 + 0.0001 ) ) );
...
ASEEND*/
//CHKSM=D520F03F50111EC474A2E0F9DCD38391A439B2BA
