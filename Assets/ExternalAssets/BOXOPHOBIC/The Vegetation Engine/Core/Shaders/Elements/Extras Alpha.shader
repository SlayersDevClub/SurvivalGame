...
#define _ElementParams_arr BOXOPHOBICTheVegetationEngineElementsDefaultExtrasAlpha
			...
			v2f vert ( appdata v )
			{
				...
				half TVE_SeasonLerp54_g22097 = TVE_SeasonLerp;
				...
				half vertexToFrag11_g22100 = ( ( ( TVE_SeasonOptions_X50_g22097 * lerpResult168_g22097 ) + ( TVE_SeasonOptions_Y51_g22097 * lerpResult167_g22097 ) ) + ( ( TVE_SeasonOptions_Z52_g22097 * lerpResult166_g22097 ) + ( TVE_SeasonOptions_W53_g22097 * lerpResult165_g22097 ) ) );
				o.ase_texcoord1.x = vertexToFrag11_g22100;
				...
				half2 vertexToFrag11_g22292 = ( ( lerpResult1899_g22097 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g22292;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half vertexToFrag11_g22100 = i.ase_texcoord1.x;
				half Value_Seasons1721_g22097 = vertexToFrag11_g22100;
				...
				half2 vertexToFrag11_g22292 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g22097 = tex2D( _MainTex, vertexToFrag11_g22292 );
				half3 temp_cast_0 = (0.0001).xxx;
				half3 temp_cast_1 = (0.9999).xxx;
				half3 clampResult17_g22290 = clamp( (MainTex_RGBA587_g22097).rgb , temp_cast_0 , temp_cast_1 );
				half temp_output_7_0_g22291 = _MainTexColorMinValue;
				half3 temp_cast_2 = (temp_output_7_0_g22291).xxx;
				half temp_output_10_0_g22291 = ( _MainTexColorMaxValue - temp_output_7_0_g22291 );
				half3 temp_output_1765_0_g22097 = saturate( ( ( clampResult17_g22290 - temp_cast_2 ) / temp_output_10_0_g22291 ) );
				...
				half clampResult17_g22288 = clamp( (MainTex_RGBA587_g22097).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g22289 = _MainTexAlphaMinValue;
				half temp_output_10_0_g22289 = ( _MainTexAlphaMaxValue - temp_output_7_0_g22289 );
				half Element_Remap_A74_g22097 = saturate( ( ( clampResult17_g22288 - temp_output_7_0_g22289 ) / ( temp_output_10_0_g22289 + 0.0001 ) ) );
				half Element_Params_A1737_g22097 = _ElementParams_Instance.w;
				half clampResult17_g22118 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				half temp_output_7_0_g22119 = _MainTexFallofMinValue;
				half temp_output_10_0_g22119 = ( _MainTexFallofMaxValue - temp_output_7_0_g22119 );
				half Element_Fallof1883_g22097 = saturate( ( ( clampResult17_g22118 - temp_output_7_0_g22119 ) / ( temp_output_10_0_g22119 + 0.0001 ) ) );
				half4 Colors37_g22108 = TVE_ColorsCoords;
				half4 Extras37_g22108 = TVE_ExtrasCoords;
				half4 Motion37_g22108 = TVE_MotionCoords;
				half4 Vertex37_g22108 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g22108 = IS_ELEMENT( Colors37_g22108 , Extras37_g22108 , Motion37_g22108 , Vertex37_g22108 );
				half4 temp_output_35_0_g22112 = localIS_ELEMENT37_g22108;
				half temp_output_7_0_g22113 = TVE_ElementsFadeValue;
				half2 temp_cast_3 = (temp_output_7_0_g22113).xx;
				half temp_output_10_0_g22113 = ( 1.0 - temp_output_7_0_g22113 );
				half2 temp_output_16_0_g22106 = saturate( ( ( abs( (( (temp_output_35_0_g22112).zw + ( (temp_output_35_0_g22112).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_3 ) / temp_output_10_0_g22113 ) );
				half2 temp_output_12_0_g22106 = ( temp_output_16_0_g22106 * temp_output_16_0_g22106 );
				half lerpResult842_g22097 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g22106).x + (temp_output_12_0_g22106).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g22097 = ( _ElementIntensity * Element_Remap_A74_g22097 * Element_Params_A1737_g22097 * i.ase_color.a * Element_Fallof1883_g22097 * lerpResult842_g22097 );
...
#define _ElementParams_arr BOXOPHOBICTheVegetationEngineElementsDefaultExtrasAlpha
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half3 clampResult17_g22290 = clamp( (MainTex_RGBA587_g22097).rgb , temp_cast_1 , temp_cast_2 );
				half temp_output_7_0_g22291 = _MainTexColorMinValue;
				half3 temp_cast_3 = (temp_output_7_0_g22291).xxx;
				half temp_output_10_0_g22291 = ( _MainTexColorMaxValue - temp_output_7_0_g22291 );
				half3 temp_output_1765_0_g22097 = saturate( ( ( clampResult17_g22290 - temp_cast_3 ) / temp_output_10_0_g22291 ) );
				half Element_Remap_R73_g22097 = (temp_output_1765_0_g22097).x;
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_R1738_g22097 = _ElementParams_Instance.x;
				half Element_Value1744_g22097 = ( Element_Remap_R73_g22097 * Element_Params_R1738_g22097 * i.ase_color.r );
				...
				half3 Input_Color94_g22260 = temp_cast_4;
				half3 break68_g22260 = Input_Color94_g22260;
				half clampResult80_g22260 = clamp( max( max( break68_g22260.x , break68_g22260.y ) , break68_g22260.z ) , 0.1 , 10000.0 );
				half4 color1875_g22097 = IsGammaSpace() ? half4(0.5,0.5,0.5,0) : half4(0.2140411,0.2140411,0.2140411,0);
				half3 Input_Tint76_g22260 = (color1875_g22097).rgb;
				half3 Element_Valid47_g22260 = ( clampResult80_g22260 * Input_Tint76_g22260 );
				half4 Colors37_g22272 = TVE_ColorsPosition;
				half4 Extras37_g22272 = TVE_ExtrasPosition;
				half4 Motion37_g22272 = TVE_MotionPosition;
				half4 Vertex37_g22272 = TVE_VertexPosition;
				half4 localIS_ELEMENT37_g22272 = IS_ELEMENT( Colors37_g22272 , Extras37_g22272 , Motion37_g22272 , Vertex37_g22272 );
				half4 Colors37_g22273 = TVE_ColorsScale;
				half4 Extras37_g22273 = TVE_ExtrasScale;
				half4 Motion37_g22273 = TVE_MotionScale;
				half4 Vertex37_g22273 = TVE_VertexScale;
				half4 localIS_ELEMENT37_g22273 = IS_ELEMENT( Colors37_g22273 , Extras37_g22273 , Motion37_g22273 , Vertex37_g22273 );
				half Bounds42_g22260 = ( 1.0 - saturate( ( distance( max( ( abs( ( WorldPosition - (localIS_ELEMENT37_g22272).xyz ) ) - ( (localIS_ELEMENT37_g22273).xyz * float3( 0.5,0.5,0.5 ) ) ) , float3( 0,0,0 ) ) , float3( 0,0,0 ) ) / 0.001 ) ) );
				half3 lerpResult50_g22260 = lerp( temp_cast_0 , Element_Valid47_g22260 , Bounds42_g22260);
				half CrossHatch44_g22260 = ( saturate( ( ( abs( sin( ( ( WorldPosition.x + WorldPosition.z ) * 3.0 ) ) ) - 0.7 ) * 100.0 ) ) * 0.25 );
				half clampResult17_g22288 = clamp( (MainTex_RGBA587_g22097).a , 0.0001 , 0.9999 );
				half temp_output_7_0_g22289 = _MainTexAlphaMinValue;
				half temp_output_10_0_g22289 = ( _MainTexAlphaMaxValue - temp_output_7_0_g22289 );
				half Element_Remap_A74_g22097 = saturate( ( ( clampResult17_g22288 - temp_output_7_0_g22289 ) / ( temp_output_10_0_g22289 + 0.0001 ) ) );
				...
				half4 temp_output_35_0_g22112 = localIS_ELEMENT37_g22108;
				half temp_output_7_0_g22113 = TVE_ElementsFadeValue;
				half2 temp_cast_5 = (temp_output_7_0_g22113).xx;
				half temp_output_10_0_g22113 = ( 1.0 - temp_output_7_0_g22113 );
				half2 temp_output_16_0_g22106 = saturate( ( ( abs( (( (temp_output_35_0_g22112).zw + ( (temp_output_35_0_g22112).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_5 ) / temp_output_10_0_g22113 ) );
				half2 temp_output_12_0_g22106 = ( temp_output_16_0_g22106 * temp_output_16_0_g22106 );
				half lerpResult842_g22097 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g22106).x + (temp_output_12_0_g22106).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g22097 = ( _ElementIntensity * Element_Remap_A74_g22097 * Element_Params_A1737_g22097 * i.ase_color.a * Element_Fallof1883_g22097 * lerpResult842_g22097 );
				half Final_Extras_A241_g22097 = Element_Alpha56_g22097;
				half Input_Alpha48_g22260 = Final_Extras_A241_g22097;
				half lerpResult57_g22260 = lerp( CrossHatch44_g22260 , Input_Alpha48_g22260 , Bounds42_g22260);
				half4 appendResult58_g22260 = (half4(lerpResult50_g22260 , lerpResult57_g22260));
				
				
				finalColor = appendResult58_g22260;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.FunctionNode;106;-640,-1408;Inherit;False;Define Element Extras;73;;20937;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
