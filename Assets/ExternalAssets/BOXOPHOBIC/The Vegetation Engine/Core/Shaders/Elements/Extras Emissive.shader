...
#define _ElementParams_arr BOXOPHOBICTheVegetationEngineElementsDefaultExtrasEmissive
			...
			v2f vert ( appdata v )
			{
				...
				half TVE_SeasonLerp54_g22783 = TVE_SeasonLerp;
				...
				float vertexToFrag11_g22786 = ( ( ( TVE_SeasonOptions_X50_g22783 * lerpResult168_g22783 ) + ( TVE_SeasonOptions_Y51_g22783 * lerpResult167_g22783 ) ) + ( ( TVE_SeasonOptions_Z52_g22783 * lerpResult166_g22783 ) + ( TVE_SeasonOptions_W53_g22783 * lerpResult165_g22783 ) ) );
				o.ase_texcoord1.x = vertexToFrag11_g22786;
				...
				float2 vertexToFrag11_g22978 = ( ( lerpResult1899_g22783 * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord1.yz = vertexToFrag11_g22978;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float vertexToFrag11_g22786 = i.ase_texcoord1.x;
				half Value_Seasons1721_g22783 = vertexToFrag11_g22786;
				...
				float2 vertexToFrag11_g22978 = i.ase_texcoord1.yz;
				half4 MainTex_RGBA587_g22783 = tex2D( _MainTex, vertexToFrag11_g22978 );
				float3 temp_cast_0 = (0.0001).xxx;
				float3 temp_cast_1 = (0.9999).xxx;
				float3 clampResult17_g22976 = clamp( (MainTex_RGBA587_g22783).rgb , temp_cast_0 , temp_cast_1 );
				float temp_output_7_0_g22977 = _MainTexColorMinValue;
				float3 temp_cast_2 = (temp_output_7_0_g22977).xxx;
				float temp_output_10_0_g22977 = ( _MainTexColorMaxValue - temp_output_7_0_g22977 );
				float3 temp_output_1765_0_g22783 = saturate( ( ( clampResult17_g22976 - temp_cast_2 ) / temp_output_10_0_g22977 ) );
				...
				float clampResult17_g22974 = clamp( (MainTex_RGBA587_g22783).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g22975 = _MainTexAlphaMinValue;
				float temp_output_10_0_g22975 = ( _MainTexAlphaMaxValue - temp_output_7_0_g22975 );
				half Element_Remap_A74_g22783 = saturate( ( ( clampResult17_g22974 - temp_output_7_0_g22975 ) / ( temp_output_10_0_g22975 + 0.0001 ) ) );
				half Element_Params_A1737_g22783 = _ElementParams_Instance.w;
				float clampResult17_g22804 = clamp( saturate( ( 1.0 - distance( (i.ase_texcoord2.xy*2.0 + -1.0) , float2( 0,0 ) ) ) ) , 0.0001 , 0.9999 );
				float temp_output_7_0_g22805 = _MainTexFallofMinValue;
				float temp_output_10_0_g22805 = ( _MainTexFallofMaxValue - temp_output_7_0_g22805 );
				half Element_Fallof1883_g22783 = saturate( ( ( clampResult17_g22804 - temp_output_7_0_g22805 ) / ( temp_output_10_0_g22805 + 0.0001 ) ) );
				half4 Colors37_g22794 = TVE_ColorsCoords;
				half4 Extras37_g22794 = TVE_ExtrasCoords;
				half4 Motion37_g22794 = TVE_MotionCoords;
				half4 Vertex37_g22794 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g22794 = IS_ELEMENT( Colors37_g22794 , Extras37_g22794 , Motion37_g22794 , Vertex37_g22794 );
				float4 temp_output_35_0_g22798 = localIS_ELEMENT37_g22794;
				float temp_output_7_0_g22799 = TVE_ElementsFadeValue;
				float2 temp_cast_3 = (temp_output_7_0_g22799).xx;
				float temp_output_10_0_g22799 = ( 1.0 - temp_output_7_0_g22799 );
				float2 temp_output_16_0_g22792 = saturate( ( ( abs( (( (temp_output_35_0_g22798).zw + ( (temp_output_35_0_g22798).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_3 ) / temp_output_10_0_g22799 ) );
				float2 temp_output_12_0_g22792 = ( temp_output_16_0_g22792 * temp_output_16_0_g22792 );
				float lerpResult842_g22783 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g22792).x + (temp_output_12_0_g22792).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g22783 = ( _ElementIntensity * Element_Remap_A74_g22783 * Element_Params_A1737_g22783 * i.ase_color.a * Element_Fallof1883_g22783 * lerpResult842_g22783 );
...
#define _ElementParams_arr BOXOPHOBICTheVegetationEngineElementsDefaultExtrasEmissive
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 clampResult17_g22976 = clamp( (MainTex_RGBA587_g22783).rgb , temp_cast_1 , temp_cast_2 );
				float temp_output_7_0_g22977 = _MainTexColorMinValue;
				float3 temp_cast_3 = (temp_output_7_0_g22977).xxx;
				float temp_output_10_0_g22977 = ( _MainTexColorMaxValue - temp_output_7_0_g22977 );
				float3 temp_output_1765_0_g22783 = saturate( ( ( clampResult17_g22976 - temp_cast_3 ) / temp_output_10_0_g22977 ) );
				half Element_Remap_R73_g22783 = (temp_output_1765_0_g22783).x;
				half4 _ElementParams_Instance = UNITY_ACCESS_INSTANCED_PROP(_ElementParams_arr, _ElementParams);
				half Element_Params_R1738_g22783 = _ElementParams_Instance.x;
				half Element_Value1744_g22783 = ( Element_Remap_R73_g22783 * Element_Params_R1738_g22783 * i.ase_color.r );
				...
				half3 Input_Color94_g22960 = temp_cast_4;
				float3 break68_g22960 = Input_Color94_g22960;
				float clampResult80_g22960 = clamp( max( max( break68_g22960.x , break68_g22960.y ) , break68_g22960.z ) , 0.1 , 10000.0 );
				float4 color1872_g22783 = IsGammaSpace() ? float4(1,0.6,0,0) : float4(1,0.3185468,0,0);
				half3 Input_Tint76_g22960 = (color1872_g22783).rgb;
				half3 Element_Valid47_g22960 = ( clampResult80_g22960 * Input_Tint76_g22960 );
				half4 Colors37_g22972 = TVE_ColorsPosition;
				half4 Extras37_g22972 = TVE_ExtrasPosition;
				half4 Motion37_g22972 = TVE_MotionPosition;
				half4 Vertex37_g22972 = TVE_VertexPosition;
				half4 localIS_ELEMENT37_g22972 = IS_ELEMENT( Colors37_g22972 , Extras37_g22972 , Motion37_g22972 , Vertex37_g22972 );
				half4 Colors37_g22973 = TVE_ColorsScale;
				half4 Extras37_g22973 = TVE_ExtrasScale;
				half4 Motion37_g22973 = TVE_MotionScale;
				half4 Vertex37_g22973 = TVE_VertexScale;
				half4 localIS_ELEMENT37_g22973 = IS_ELEMENT( Colors37_g22973 , Extras37_g22973 , Motion37_g22973 , Vertex37_g22973 );
				half Bounds42_g22960 = ( 1.0 - saturate( ( distance( max( ( abs( ( WorldPosition - (localIS_ELEMENT37_g22972).xyz ) ) - ( (localIS_ELEMENT37_g22973).xyz * float3( 0.5,0.5,0.5 ) ) ) , float3( 0,0,0 ) ) , float3( 0,0,0 ) ) / 0.001 ) ) );
				float3 lerpResult50_g22960 = lerp( temp_cast_0 , Element_Valid47_g22960 , Bounds42_g22960);
				half CrossHatch44_g22960 = ( saturate( ( ( abs( sin( ( ( WorldPosition.x + WorldPosition.z ) * 3.0 ) ) ) - 0.7 ) * 100.0 ) ) * 0.25 );
				float clampResult17_g22974 = clamp( (MainTex_RGBA587_g22783).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g22975 = _MainTexAlphaMinValue;
				float temp_output_10_0_g22975 = ( _MainTexAlphaMaxValue - temp_output_7_0_g22975 );
				half Element_Remap_A74_g22783 = saturate( ( ( clampResult17_g22974 - temp_output_7_0_g22975 ) / ( temp_output_10_0_g22975 + 0.0001 ) ) );
				...
				float4 temp_output_35_0_g22798 = localIS_ELEMENT37_g22794;
				float temp_output_7_0_g22799 = TVE_ElementsFadeValue;
				float2 temp_cast_5 = (temp_output_7_0_g22799).xx;
				float temp_output_10_0_g22799 = ( 1.0 - temp_output_7_0_g22799 );
				float2 temp_output_16_0_g22792 = saturate( ( ( abs( (( (temp_output_35_0_g22798).zw + ( (temp_output_35_0_g22798).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_5 ) / temp_output_10_0_g22799 ) );
				float2 temp_output_12_0_g22792 = ( temp_output_16_0_g22792 * temp_output_16_0_g22792 );
				float lerpResult842_g22783 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g22792).x + (temp_output_12_0_g22792).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g22783 = ( _ElementIntensity * Element_Remap_A74_g22783 * Element_Params_A1737_g22783 * i.ase_color.a * Element_Fallof1883_g22783 * lerpResult842_g22783 );
				half Final_Extras_A241_g22783 = Element_Alpha56_g22783;
				half Input_Alpha48_g22960 = Final_Extras_A241_g22783;
				float lerpResult57_g22960 = lerp( CrossHatch44_g22960 , Input_Alpha48_g22960 , Bounds42_g22960);
				float4 appendResult58_g22960 = (float4(lerpResult50_g22960 , lerpResult57_g22960));
				
				
				finalColor = appendResult58_g22960;
				return finalColor;
			}
			ENDCG
		}
