// Upgrade NOTE: upgraded instancing buffer 'HiddenBOXOPHOBICTheVegetationEngineElementsDefaultMotionTurbulence' to new syntax.

// Made with Amplify Shader Editor v1.9.1.5
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Hidden/BOXOPHOBIC/The Vegetation Engine/Elements/Default/Motion Turbulence"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(HiddenBOXOPHOBICTheVegetationEngineElementsDefaultMotionTurbulence)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr HiddenBOXOPHOBICTheVegetationEngineElementsDefaultMotionTurbulence
			UNITY_INSTANCING_BUFFER_END(HiddenBOXOPHOBICTheVegetationEngineElementsDefaultMotionTurbulence)
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 MainTex_RGBA587_g20948 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.xy ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				float3 temp_cast_2 = (0.0001).xxx;
				float3 temp_cast_3 = (0.9999).xxx;
				float3 clampResult17_g21058 = clamp( (MainTex_RGBA587_g20948).rgb , temp_cast_2 , temp_cast_3 );
				...
				float3 temp_output_1765_0_g20948 = saturate( ( ( clampResult17_g21058 - temp_cast_4 ) / temp_output_10_0_g21071 ) );
				...
				float2 appendResult1382_g20948 = (float2(i.ase_texcoord1.z , i.ase_texcoord2.x));
				half2 Direction_Velocity1394_g20948 = ( appendResult1382_g20948 / i.ase_texcoord2.y );
				...
				half2 Noise_Coords1409_g20948 = ( -( (( WorldPosition + TVE_WorldOffset )).xz * 0.1 ) * Noise_Scale892_g20948 );
				...
				float temp_output_15_0_g21053 = ( lerpResult115_g21052 * Noise_Speed898_g20948 );
				...
				float clampResult17_g21057 = clamp( (MainTex_RGBA587_g20948).a , 0.0001 , 0.9999 );
				...
				half Element_Remap_A74_g20948 = saturate( ( ( clampResult17_g21057 - temp_output_7_0_g21059 ) / ( temp_output_10_0_g21059 + 0.0001 ) ) );
				...
				half Element_Alpha56_g20948 = ( _ElementIntensity * Element_Remap_A74_g20948 * Element_Params_A1737_g20948 * i.ase_color.a * lerpResult842_g20948 );
...
Node;AmplifyShaderEditor.FunctionNode;177;-640,-1280;Inherit;False;Define Element Motion;67;;20879;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-320,-1024;Float;False;True;-1;2;TVEShaderElementGUI;0;5;Hidden/BOXOPHOBIC/The Vegetation Engine/Elements/Default/Motion Turbulence;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;True;True;2;5;False;;10;False;;4;1;False;;1;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;True;True;True;True;True;True;0;False;_render_colormask;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;4;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;DisableBatching=True=DisableBatching;True;2;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
Node;AmplifyShaderEditor.FunctionNode;281;-640,-1024;Inherit;False;Base Element;2;;20948;0e972c73cae2ee54ea51acc9738801d0;4,477,2,478,0,145,3,481,2;0;1;FLOAT4;0
WireConnection;0;0;281;0
ASEEND*/
//CHKSM=C23A9CBD089E78FF9667949266EEDCB5CA2E0655