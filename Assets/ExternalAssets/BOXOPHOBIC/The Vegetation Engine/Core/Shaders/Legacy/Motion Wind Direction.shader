// Upgrade NOTE: upgraded instancing buffer 'HiddenBOXOPHOBICTheVegetationEngineElementsDefaultMotionWindDirection' to new syntax.
...
Shader "Hidden/BOXOPHOBIC/The Vegetation Engine/Elements/Default/Motion Wind Direction"
{
	...
	LOD 0
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(HiddenBOXOPHOBICTheVegetationEngineElementsDefaultMotionWindDirection)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ElementParams)
#define _ElementParams_arr HiddenBOXOPHOBICTheVegetationEngineElementsDefaultMotionWindDirection
			UNITY_INSTANCING_BUFFER_END(HiddenBOXOPHOBICTheVegetationEngineElementsDefaultMotionWindDirection)
			...
			v2f vert ( appdata v )
			{
				...
				float vertexToFrag11_g53339 = ( ( ( TVE_SeasonOptions_X50_g53336 * lerpResult168_g53336 ) + ( TVE_SeasonOptions_Y51_g53336 * lerpResult167_g53336 ) ) + ( ( TVE_SeasonOptions_Z52_g53336 * lerpResult166_g53336 ) + ( TVE_SeasonOptions_W53_g53336 * lerpResult165_g53336 ) ) );
				o.ase_texcoord1.x = vertexToFrag11_g53339;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float vertexToFrag11_g53339 = i.ase_texcoord1.x;
				half Value_Seasons1721_g53336 = vertexToFrag11_g53339;
				...
				half4 MainTex_RGBA587_g53336 = tex2D( _MainTex, ( ( ( 1.0 - i.ase_texcoord1.yz ) * (_MainUVs).xy ) + (_MainUVs).zw ) );
				float3 temp_cast_0 = (0.0001).xxx;
				float3 temp_cast_1 = (0.9999).xxx;
				float3 clampResult17_g53346 = clamp( (MainTex_RGBA587_g53336).rgb , temp_cast_0 , temp_cast_1 );
				float temp_output_7_0_g53350 = _MainTexColorMinValue;
				float3 temp_cast_2 = (temp_output_7_0_g53350).xxx;
				float temp_output_10_0_g53350 = ( _MainTexColorMaxValue - temp_output_7_0_g53350 );
				float3 temp_output_1765_0_g53336 = saturate( ( ( clampResult17_g53346 - temp_cast_2 ) / temp_output_10_0_g53350 ) );
				...
				float clampResult17_g53345 = clamp( (MainTex_RGBA587_g53336).a , 0.0001 , 0.9999 );
				float temp_output_7_0_g53347 = _MainTexAlphaMinValue;
				float temp_output_10_0_g53347 = ( _MainTexAlphaMaxValue - temp_output_7_0_g53347 );
				half Element_Remap_A74_g53336 = saturate( ( ( clampResult17_g53345 - temp_output_7_0_g53347 ) / ( temp_output_10_0_g53347 + 0.0001 ) ) );
				half Element_Params_A1737_g53336 = _ElementParams_Instance.w;
				half4 Colors37_g53353 = TVE_ColorsCoords;
				half4 Extras37_g53353 = TVE_ExtrasCoords;
				half4 Motion37_g53353 = TVE_MotionCoords;
				half4 Vertex37_g53353 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g53353 = IS_ELEMENT( Colors37_g53353 , Extras37_g53353 , Motion37_g53353 , Vertex37_g53353 );
				float4 temp_output_35_0_g53357 = localIS_ELEMENT37_g53353;
				float temp_output_7_0_g53358 = TVE_ElementsFadeValue;
				float2 temp_cast_3 = (temp_output_7_0_g53358).xx;
				float temp_output_10_0_g53358 = ( 1.0 - temp_output_7_0_g53358 );
				float2 temp_output_16_0_g53351 = saturate( ( ( abs( (( (temp_output_35_0_g53357).zw + ( (temp_output_35_0_g53357).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_3 ) / temp_output_10_0_g53358 ) );
				float2 temp_output_12_0_g53351 = ( temp_output_16_0_g53351 * temp_output_16_0_g53351 );
				float lerpResult842_g53336 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g53351).x + (temp_output_12_0_g53351).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha56_g53336 = ( _ElementIntensity * Element_Remap_A74_g53336 * Element_Params_A1737_g53336 * i.ase_color.a * lerpResult842_g53336 );
...
Node;AmplifyShaderEditor.FunctionNode;199;-640,-1024;Inherit;False;Base Element;2;;53336;0e972c73cae2ee54ea51acc9738801d0;4,477,2,478,0,145,3,481,0;0;1;FLOAT4;0
WireConnection;0;0;199;0
ASEEND*/
//CHKSM=DC590E550EB5FBF478866689A2F9EF7F84B6EEBC