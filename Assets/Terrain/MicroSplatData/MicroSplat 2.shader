...
Shader "Terrain_0_0_b1c9917c-1634-4833-acfd-edc24cd72431"
{
   Properties
   {
   ...
   SubShader
   {
            Tags {"RenderPipeline" = "UniversalPipeline"  "RenderType" = "HDLitShader" "Queue" = "Geometry+100" "IgnoreProjector" = "False"  "TerrainCompatible" = "true" "SplatCount" = "4"}
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/Terrain_0_0_b1c9917c-1634-4833-acfd-edc24cd72431_Base1978849203"
   Fallback "Hidden/Terrain_0_0_b1c9917c-1634-4833-acfd-edc24cd72431_Base1978849203"
