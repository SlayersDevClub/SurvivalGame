...
Shader "Terrain_0_0_44f16c4d-c9c1-4d03-bcac-914b89708ea6"
{
   Properties
   {
      ...
      _HeightWetness("Height Wetness Params", Vector) = (1, 0.1, 1, 1)
      // streams
   ...
   SubShader
   {
            Tags {"RenderPipeline" = "UniversalPipeline"  "RenderType" = "HDLitShader" "Queue" = "Geometry+100" "IgnoreProjector" = "False"  "TerrainCompatible" = "true" "SplatCount" = "8"}
...
float3 GetTessFactors ()
{
   ...
   Dependency "BaseMapShader" =  "Hidden/Terrain_0_0_44f16c4d-c9c1-4d03-bcac-914b89708ea6_Base-1247043813"
   Fallback "Hidden/Terrain_0_0_44f16c4d-c9c1-4d03-bcac-914b89708ea6_Base-1247043813"
